 ...
 *       &lt;sequence&gt;
 *         &lt;element name="UpdatedOrganizationalGroup" type="{http://orggroup.types.lmsapi.message.webservice.lms.vu360.softech.com}ResponseOrganizationalGroup" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "", propOrder = {
    "updatedOrganizationalGroup"
})
@XmlRootElement(name = "UpdateOrganizationGroupResponse")
public class UpdateOrganizationGroupResponse
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "UpdatedOrganizationalGroup")
    protected ResponseOrganizationalGroup updatedOrganizationalGroup;
    ...
    /**
     * Gets the value of the updatedOrganizationalGroup property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public ResponseOrganizationalGroup getUpdatedOrganizationalGroup() {
        return updatedOrganizationalGroup;
    }

    /**
     * Sets the value of the updatedOrganizationalGroup property.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseOrganizationalGroup }
     *     
     */
    public void setUpdatedOrganizationalGroup(ResponseOrganizationalGroup value) {
        this.updatedOrganizationalGroup = value;
    }

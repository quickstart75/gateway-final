...
import com.softech.ls360.lcms.api.config.spring.properties.LcmsApiPropertiesConfig;
 ...
 */
@Configuration
@Import({LcmsApiPropertiesConfig.class})
public class LcmsApiWebServiceConfig {
	 ...
	 */
	@Bean
	public Jaxb2Marshaller lcmsApiJaxb2Marshaller() {
		 
		Jaxb2Marshaller marshaller = new Jaxb2Marshaller();
		String[] packagesToScan = {"com.softech.ls360.lcms.api.webservice.client.stub"};
	  ...
	  */
	@Bean
	public WebServiceTemplate lcmsApiWebServiceTemplate() {
		 
		WebServiceTemplate webServiceTemplate = new WebServiceTemplate();
		webServiceTemplate.setMessageFactory(soapMessageFactory());
		webServiceTemplate.setDefaultUri(env.getProperty("lcms.api.uri.playerutility.wsdl"));
		webServiceTemplate.setMarshaller(lcmsApiJaxb2Marshaller());
		webServiceTemplate.setUnmarshaller(lcmsApiJaxb2Marshaller());
